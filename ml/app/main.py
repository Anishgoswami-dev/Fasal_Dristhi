...
app = FastAPI(
    title="Krishi Sathi Real AI Plant Disease Vision Service",
    description="Real Computer Vision & Deep Learning Microservice for Agricultural Plant Disease Detection",
...
async def health_check():
    """Health check endpoint returning real model readiness and hardware status."""
    classifier = get_classifier()
    return {
